...
#	angle computed orientation of the keypoint (-1 if not applicable); it's in [0,360) degrees 
#	and measured relative to image coordinate system (y-axis is directed downward), i.e in clockwise.
#	response the response by which the most strong keypoints have been selected. Can be used for 
