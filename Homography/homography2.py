# Ce programme permet de mapper une image source (premier argument) dans une zone 
# constituée de quatre points sélectionnée par l'utilisateur.
# les points sont sélectionnés dans le sens des aiguilles d'une montre.
# syntaxe prog imagesource imagedestination
#book1 nls9oh f book2(zone selected)
import cv2
import numpy as np
import sys
